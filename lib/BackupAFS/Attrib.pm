#============================================================= -*-perl-*-
#
# BackupAFS::Attrib package
#
# DESCRIPTION
#
#   This library defines a BackupAFS::Attrib class for maintaining
...
sub read
{
    ...
    my $fd = BackupAFS::FileZIO->open($file, 0, $a->{compress});
    if ( !$fd ) {
...
sub write
{
    ...
    my $fd = BackupAFS::FileZIO->open($file, 1, $a->{compress});
    if ( !$fd ) {
