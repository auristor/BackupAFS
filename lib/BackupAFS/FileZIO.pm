#============================================================= -*-perl-*-
#
# BackupAFS::FileZIO package
#
# DESCRIPTION
#
#   This library defines a BackupAFS::FileZIO class for doing
...
sub compressCopy
{
    ...
    if ( $CompZlibOK && $compress > 0 ) {
        my $fh = BackupAFS::FileZIO->open($destFileZ, 1, $compress);
        my $data;
