...
This documentation describes BackupPC version 3.0.0,
released on 28 Jan 2007.
...
BackupPC-3.0.0.tar.gz, run these commands as root:
...
available, eg: BackupPC-3.0.0pl2.diff, you should apply
the patch after extracting the tar file:

     # fetch BackupPC-3.0.0.tar.gz
     # fetch BackupPC-3.0.0pl2.diff
     tar zxf BackupPC-3.0.0.tar.gz
     cd BackupPC-3.0.0
     patch -p0 < ../BackupPC-3.0.0pl2.diff
     perl configure.pl
